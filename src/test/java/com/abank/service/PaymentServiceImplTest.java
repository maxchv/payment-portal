...
public class PaymentServiceImplTest {
    ...
    @Test
    public void testCreatePayment2() throws AccountNotFoundException, NotEnoughMoney {
        // Arrange
        ...
        client3.setId(123L);
        client3.setAccounts(new ArrayList<Account>());
        ...
        when(this.accountRepository.save((Account) any())).thenReturn(account3);
        ...
        verify(this.accountRepository, times(2)).findById((Long) any());
        verify(this.accountRepository, times(2)).save((Account) any());
    }
